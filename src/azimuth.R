## azimuth reference create functions, (install azimuth cause problems) ----
# extracted from https://github.com/satijalab/azimuth/blob/master/R/azimuth.R on May 9th, 2022
#' @include zzz.R
#' @include helpers.R
#' @include ui.R
#'
