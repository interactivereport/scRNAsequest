...
For NEBULA, users can choose from **HL** and **LN**, and the pipeline uses 'HL' by default. The differences between them can be found in the [NEBULA GitHub page](https://github.com/lhe17/nebula):
