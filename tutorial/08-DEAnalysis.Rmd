...
If user is interested in using a numeric variable (such as Age) as the comparison group in the comparison. Please provide the column header of the numeric column in the cell/sample meta table in the **"group"** column of the above DEGinfo.csv table, and leave **"alt"** and **"ref"** columns of that row empty. This is currently only supported in the NEBULA method.
