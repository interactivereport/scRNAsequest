...
Now we are ready to run the pipeline. Since the main pipeline script `scAnalyzer` requires a config.yml file, a sample meta information file, and a DEGinfo.csv file for DE analysis (can be filled in later), we can first generate templates for these files.
