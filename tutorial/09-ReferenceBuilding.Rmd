...
In this demo, we use a previously processed RDS file using cell type annotation from a public project: [GSE172462](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE172462). The RDS file is: [GSE172462.SCT.For_scRef.rds](https://github.com/interactivereport/scRNAsequest/releases/download/untagged-e92025b745dbc6f9666a/GSE172462.SCT.For_scRef.rds).
