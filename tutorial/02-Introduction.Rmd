...
This pipeline contains two main programs:
  ...
  - **scAnalyzer**
    ...
    Also, scAnalyzer is an all-in-one program for downstream data analysis, including pre-processing, batch correction, label transfer, differential gene expression analysis and CellDepot integration. Moreover, scAnalyzer is embedded with a Bookdown report generator, which can produce a user-friendly, well-structured quality control report after each run.
