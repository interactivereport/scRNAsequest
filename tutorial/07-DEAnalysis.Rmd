...
The first column, **comparisonName** is designed to store the name of the comparison. This name will become separate folders under the result directory. In the DEG comparison file above, **“sample”**, **“cluster”**, **“group”** and **“covars”** are the annotation headers, and **“alt”** and **“ref”** are the two entries from **“group”** column. The **“covars”** is optional and can be empty.
